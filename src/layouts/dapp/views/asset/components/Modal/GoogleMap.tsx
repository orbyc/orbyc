 ...
 */
import { Tooltip, Box, ListItem, UnorderedList, Link, useDisclosure, ModalOverlay, Modal, ModalContent, ModalHeader, ModalCloseButton, ModalBody } from '@chakra-ui/react';
...
const MapPoints = (props: MapPointsProps) => {
    ...
    return (
        <React.Fragment>
            <Tooltip bg='white' color='green' hasArrow label={<ProductContentComponent data={props.data} />} arrowSize={15}>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <Box margin="20px" display="flex" alignContent="center" justifyContent="center">
...
export const SimpleMapPage = (props: SimpleMapPageProps) => {
    ...
    return (
        <div style={{ height: '700px', width: '100%' }}>
            ...
            >
                {props.stakeHolders && props.stakeHolders.length > 0 ? props.stakeHolders.map((stakeHolder, index) => {
                    return <MapPoints
                        key={index}
                        lat={stakeHolder.lat}
                        lng={stakeHolder.lng}
